...
from reuse_conv.train_resnet import ReuseResNet, Bottleneck
...
def test():
    ...
    prepared_model.load_state_dict(torch.load("./reuse_conv/resnet50.pth"))
    remove_reused_bn_param_hack(prepared_model)
    quantized_model = convert_pt2e(prepared_model)

    # onnx session
    sess = ort.InferenceSession("./reuse_conv/resnet50_qat_sim.onnx")
    ...
    top1, top5 = evaluate_np(sess, data_loader_test, total_size=100)
