...
from ultralytics.utils.quantizer_utils import (
...
def get_quantization_config(
    ...
    act_dtype: torch.dtype = torch.uint8,
    act_qmin: int = 0,
    act_qmax: int = 255,
...
class AXQuantizer(Quantizer):
    ...
    def set_global(self, quantization_config: QuantizationConfig) -> AXQuantizer:
    ...
    def annotate(self, model: torch.fx.GraphModule) -> torch.fx.GraphModule:
        ...
        from ultralytics.utils.quantizer import get_quantization_config
