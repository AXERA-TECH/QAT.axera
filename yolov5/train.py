# ============================================================================
# axquant 参考补丁(torch 2.10;本文件不在本仓库内运行,
# 用法:拷入 ultralytics/yolov5 检出目录,并把 QAT.axera/utils/ 整个包拷为
# 同目录下的 qat_utils/(⚠️ 不能叫 utils,会与 yolov5 自带 utils 包冲突);
# 环境按 QAT.axera/requirements.txt(torch 2.10)配置。
# ============================================================================
...
def train(hyp, opt, device, callbacks):
    ...
    from qat_utils.ax_quantizer import AXQuantizer, load_config
    from qat_utils.train_utils import capture
    import qat_utils.quantized_decomposed_dequantize_per_channel  # noqa: F401 注册 per-channel torchlib 映射
